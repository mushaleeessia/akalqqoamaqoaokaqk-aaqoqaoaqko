...
export const CartoonDialog = ({ message, isVisible, onClose }: CartoonDialogProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none">
      <div className="relative bg-white border-4 border-black rounded-lg p-4 shadow-2xl animate-scale-in pointer-events-auto max-w-xs">
        {/* Speech bubble tail */}
        ...
        <div className="absolute -bottom-2 left-8 w-0 h-0 border-l-[12px] border-l-transparent border-r-[12px] border-r-transparent border-t-[12px] border-t-white ml-[3px]"></div>
